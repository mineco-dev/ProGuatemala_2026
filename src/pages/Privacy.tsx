        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white max-w-3xl mx-auto">
              {language === 'es'
                ? 'Última actualización: Febrero 2024. Su privacidad es importante para nosotros.'
                : 'Last updated: February 2024. Your privacy is important to us.'}
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h4 className="font-bold text-gray-900 mb-2">
              {language === 'es' ? 'Actualizaciones de esta Política' : 'Policy Updates'}
            </h4>
