  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Altura acotada a dos filas: el catalogo se desplaza dentro de su
            propio panel en lugar de estirar la pagina.
        ...
        <div
          ...
          tabIndex={0}
          className="max-h-[min(47.5rem,75vh)] overflow-y-auto overscroll-contain rounded-2xl border border-gray-200 bg-white/50 p-3 sm:p-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        >
            ...
            {resources.map((resource, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 border border-gray-100 flex flex-col justify-between min-h-[22rem]"
                >
                  <div>
